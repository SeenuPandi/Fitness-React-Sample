                                    ...
                                    <div className="e-card-header">
                                        ...
                                        {(props.isBreakFastMenuAdded && props.isToday) &&
                                            <div className="e-meals-edit">
                                                <div className="e-breakfast-edit icon-edit-2"></div>
                                            </div>
                                        }
                                    </div>
                                    <div className="e-card-content">
                                        ...
                                        {!props.isBreakFastMenuAdded &&
                                            <div>
                                                ...
                                                <button class="e-add-menu-btn e-breakfast-add-btn">ADD MENU</button>
                                            </div>
                                        }
                                    </div>
                                </div>
                                    ...
                                    <div className="e-card-content">
                                        ...
                                        {!props.isSnack1MenuAdded &&
                                            <div>
                                                ...
                                                <button className="e-add-menu-btn e-snack1-add-btn">ADD MENU</button>
                                            </div>
                                        }
                                    </div>
                                </div>
                                <div className="e-card e-meals-card">
                                    <div className="e-card-header">
                                        ...
                                        {(props.isLunchMenuAdded && props.isToday) &&
                                            <div className="e-meals-edit">
                                                <div className="e-lunch-edit icon-edit-2" onClick={editMenu}></div>
                                            </div>
                                        }
                                    </div>
                                    <div className="e-card-content">
                                        ...
                                        {!props.isLunchMenuAdded &&
                                            <div>
                                                <div className="e-recom-meals-text">Recommended</div>
                                                <div className="e-recom-meals-value"> {lunchRecom} <span className="e-card-cal-unit">kcal</span>
                                                </div>
                                                <button className="e-add-menu-btn e-lunch-add-btn">ADD MENU</button>
                                            </div>}
                                    </div>
                                </div>
                                <div className="e-card e-meals-card">
                                    <div className="e-card-header">
                                        ...
                                        {(props.isSnack2MenuAdded && props.isToday) &&
                                            <div className="e-meals-edit">
                                                <div className="e-snack2-edit icon-edit-2" onClick={editMenu}></div>
                                            </div>}
                                    </div>
                                    <div className="e-card-content">
                                        <div className="e-card-header-caption">
                                        ...
                                        {props.isSnack2MenuAdded &&
                                            <div>
                                                ...
                                                <div className="e-calories-gain">{currentSnack2Calories} <span
                                                    className="e-card-cal-unit e-add-cal-unit">kcal</span></div>
                                            </div>}
                                        {!props.isSnack2MenuAdded &&
                                            <div>
                                                ...
                                                <button className="e-add-menu-btn e-snack2-add-btn">ADD MENU</button>
                                            </div>}
                                    </div>
                                </div>
                                <div className="e-card e-meals-card e-dinner-card">
                                    <div className="e-card-header">
                                        ...
                                        {(props.isDinnerMenuAdded && props.isToday) &&
                                            <div className="e-meals-edit">
                                                <div className="e-dinner-edit icon-edit-2" onClick={editMenu}></div>
                                            </div>}
                                    </div>
                                    <div className="e-card-content">
                                        <div className="e-card-header-caption">
                                        ...
                                        {props.isDinnerMenuAdded &&
                                            <div>
                                                <div className="e-had-meals">
                                                    <div className="e-meals-value" title="currentDinnerMenuText"> {props.currentDinnerMenuText} </div>
                                                </div>
                                        ...
                                        {!props.isDinnerMenuAdded &&
                                            <div >
                                                ...
                                                <button className="e-add-menu-btn e-dinner-add-btn" >ADD MENU</button>
                                            </div>}
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="e-panel-container">
                            <div className="e-panel-header">
                                ...
                                <div className="col-lg-3 col-md-4 col-sm-4 col-xs-12 e-burned">
                                    ...
                                    <div className="e-consumed-wrapper-value col-lg-8 col-md-8 col-sm-8 col-xs-6">
                                        {props.burnedCalories}
